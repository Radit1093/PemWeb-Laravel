                ...
                <div class="movie-grid">
                    @forelse ($movies as $movie)
                        <div class="movie-card">
                            ...
                            @else
                                <img src="./static/default-poster.jpg" alt="No Poster">
                            @endif
                            <p>{{ Str::limit($movie->synopsis, 50) }}</p>
                            <p><strong>Tahun:</strong> {{ $movie->year }}</p>
                            <p><strong>Genre:</strong> {{ $movie->genre->name }}</p>
                            <p><strong>Tersedia:</strong> {{ $movie->available ? 'Ya' : 'Tidak' }}</p>
                            <a href="{{ route('movies.show', $movie->id) }}" class="btn btn-info btn-sm">Lihat</a>
                            <a href="{{ route('movies.edit', $movie->id) }}" class="btn btn-warning btn-sm">Ubah</a>
                    ...
                    @empty
                        <div class="text-center text-muted">Tidak ada data film yang ditemukan.</div>
                    @endforelse
                </div>
            </div>
        </div>
